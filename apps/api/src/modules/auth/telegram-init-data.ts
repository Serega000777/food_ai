 ...
 * (re-checked against the current docs 2026-09-05 — unchanged from the reference
 ...
 *
 * The docs recommend checking `auth_date` for staleness without mandating a TTL — 24h
 * (plus 60s of clock-skew tolerance) is this app's own policy, not a Telegram requirement.
 */
